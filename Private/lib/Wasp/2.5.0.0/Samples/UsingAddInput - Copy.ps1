## Yeah, we can simulate all sorts of mouse and keyboard input ...
## Even drag windows around by the title
Select-UIElement -ProcessName Trillian -Name "#PowerShell*" | ForEach { 
   # To drag it with the mouse, we need to offset onto the draggable part of the title
   Add-Input -MouseMoveX ($_.BoundingRectangle.X+50) -MouseMoveY ($_.BoundingRectangle.Y+15) | 
   Add-Input -MouseDown LeftButton | 
   # When we move, keep that offset
   Add-Input -MouseMoveX 50 -MouseMoveY 15 | 
   Add-Input -MouseUp LeftButton | 
   Add-Input -Input "Hello From WASP2" |
   Add-Input -KeyPress "RETURN" |
   Send-Input -WindowHandle $_.NativeWindowHandle
}

## Or we can use Transform.Move
Select-UIElement -ProcessName Trillian -Name "#PowerShell*" | 
Invoke-Transform.Move -x 0 -y 0 -Passthru |
Send-Input -Input "Hello From WASP2`r"


# SIG # Begin signature block
# MIIarwYJKoZIhvcNAQcCoIIaoDCCGpwCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUZR+rOCaHFa0hWy2lmQUivenN
# vaSgghXlMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# KoZIhvcNAQkEMRYEFC+BwPOW+l2GGkcyjnqJ0fHHUOT6MA0GCSqGSIb3DQEBAQUA
# BIIBAIxnyAAqKYRKrgUcrlG1Szr//G/dOnbKA/QQM8cwEtICVBAvshytXVlp1dma
# DMChcxk9uEzLX9VAAHoekQ4/aNCpdTTWtmv91WcZDclrim3tJPDeUcJhTJepLoqF
# baZLNYD4F8iZkiN0HmUFRG8UDh8pQ8eOmzlDYREU8/lVvQCgLS82vPXW/ai8toz5
# 8OVKM8tshd/lSK+I9pHisgTD5XGNl/8RTHirfEjNNCUKp7zvf4ZICeH/yclk74cr
# NgaYpBYRWNaxn0xLdHQ58sbDpQBneij+4dc+SWHzJ/7YsthCti35k5pRxPCvbPB3
# MJS6gzG/TqIZ9kZsuF28SMR6/B2hggILMIICBwYJKoZIhvcNAQkGMYIB+DCCAfQC
...
# MQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMTMxMTA4MTgzMTU5WjAjBgkq
# hkiG9w0BCQQxFgQUaJ2y7KmbbFck4ZCDMEYeDzDqwEowDQYJKoZIhvcNAQEBBQAE
# ggEAjb+d2OwNKTIKr/PGmKeDtnnLICU1t4Z0dRkAxynADxXAc9YZio/FQ5LK9TSn
# YVxEOYFb+usSsSpGa85j04khJnxn/MQL7kGG3ykr++afEFqhAXXZvf+hvI9J6VEP
# YHH4PSSJZRWibOPSVi5qIB/2IcxhhvSvPevoP4Vwj8CcjPWraXdKhwVVETUEsYJu
# HfUw0oOcmayfOu3B4WbNdimLRcSRxttuWtAxftWIZiIeWcmGdMIUHV9ejVaBPUed
# NwSUBwUKwJVK+DZUyvkJdEF7AeDi2Y4oHPdSB8IGI/CITUi+9HP6T9NLjRxxzGAc
# AjA3gXPOFnoZFXH+v34v5c3lwQ==
