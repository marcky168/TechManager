...
## Create a new File 
$notepad | Select-UIElement "File" -Type MenuItem -Recurse -First | Expand-UIElement -Passthru | Select-UIElement "New" -Recurse -First | Invoke-UIElement
## Select the tab for the new file (no need to do that)
# $notepad | select-UIElement -ControlType Tab | Select-UIelement "new *" | Select-UIItem
## Enter in some text :)
$notepad | Select-UIElement -ClassName Scintilla | Send-Input @"
ipmo WASP
$app = Start-Process Notepad++ -PassThru
Start-Sleep 1
$notepad = Select-UIElement -ProcessName Notepad++ 
...
# $notepad | select-UIElement -ControlType Tab | Select-UIelement "new *" | Select-UIItem
## Enter in some text :)
$notepad | Select-UIElement -ClassName Scintilla | Send-Input "Hello"
"@

# SIG # Begin signature block
# MIIarwYJKoZIhvcNAQcCoIIaoDCCGpwCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUtwsT6l9T6OR7WDEDMPGltFw8
# O5agghXlMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# KoZIhvcNAQkEMRYEFIhY+WWGQSavfZqRw/uyIC656xWoMA0GCSqGSIb3DQEBAQUA
# BIIBAKEaRxwaB/oBbcF/oOEMUGsULWBDAAKfQnb3sF+104mATgW2FsIKbY8Dghqb
# 7DpdNkz7Pd1Pep8CDLYjy8KyjQsHc9DcRlBukcXWMxR4qB+YzhbvV/FxT/tt+VfO
# 65g1yREJqNG0t43sXe8uKDJioOVtaqRSWXNIt95pG06dwz+TJVg7K2DWru2qqYmA
# oKNQUyJaj5v+v5NzcxcDbRT9bTMfoEfM4Lq4LOIMPw3R1BcHa3MODCKVARWmejc3
# 8T2LS2nQ7mLaRTROXRwCUoQXzRunpP5Wp+yORazgx2v1uyurI1tntlLP2uCsx0hH
# cwt1CBt4y1xZfwiV1V9pobnG8PShggILMIICBwYJKoZIhvcNAQkGMYIB+DCCAfQC
...
# hkiG9w0BCQQxFgQUougJqK69CnfOsO54/gLItXj1K2AwDQYJKoZIhvcNAQEBBQAE
# ggEAakuUJ+xWpm3laFDduguJFPQogaLTEhE/Y9dXCl/mO4rA1FgkwgDPQHBub0pc
# wjQHn5b1YVApOhkgISWE1XSm6tYjGUQ2JpJ0FLyojcZtsQGAdqnBh6idk6Fou3xF
# TNeDSMz6wM3OtqWhSi6/Xr3DytJSoplVBe/M2x0qb/XgNOr9frl7P9UlLL6fIMWP
# 3IpxykDfhPU1qyKZLiZ549iapJYjyhBjxZ/ELYsJK3KkF/TJrzi0K1a/CS7e1Sho
# mc8KvVLCASkjOChxYuUTGgGag7dlKLEMe6IkFj0aEU75S9XWehjk77sMg+yHAOda
# v4XeehctDOSpp+7D8TT3fl2Ukg==
